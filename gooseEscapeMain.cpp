...
/*
    ...
    function as well?
*/
    map[1][1] = SHALL_NOT_PASS; //make this random
    map[20][10] = WINNER; // make this random
...
*/
                    ...
                    && !captured(player,monster))
	{
        ...
        if (keyEntered != TK_ESCAPE && keyEntered != TK_CLOSE)
        {
           ...
           // chasePlayer(keyEntered,player,map);
            //update the monster
            //monster.update();
    ...
    if (keyEntered != TK_CLOSE)
    {
        ...
        //assume that if the game is over and not caught, then you win
